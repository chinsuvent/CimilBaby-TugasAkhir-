...
@section('contents')
    ...
    <hr>
    <form action="{{ route('pelanggan.updateProfil', $pelanggan->id) }}" method="POST">
    @csrf
    @method('PUT')
        <div class="row">
            <div class="col mb-3">
                <label class="form-label">Nama Lengkap</label>
                <input type="text" name="nama_orang_tua" class="form-control" placeholder="Nama Lengkap" value="{{ $pelanggan->name }}">
            </div>
            <div class="col mb-3">
        ...
        <div class="row">
            <div class="col mb-3">
                ...
                <input type="email" name="email" class="form-control" placeholder="Email" value="{{ $pelanggan->email }}">
            </div>
        </div>
        <div class="row">
            <div class="col mb-3">
                <label class="form-label">No. HP</label>
                <input type="text" name="no_hp" class="form-control" placeholder="No. HP" value="{{ $pelanggan->no_hp }}">
            </div>
            <div class="col mb-3">
