...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center" href="{{ route('pelanggan.dashboard') }}">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center" href="{{ route('pelanggan.profil') }}">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center" href="{{ route('pelanggan.anak') }}">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center" href="{{ route('pelanggan.reservasi') }}">
                    <span class="mr-2">Reservasi</span>
            ...
            <li class="nav-item">
                <a class="nav-link d-flex align-items-center" href="{{ route('pelanggan.kehadiran') }}">
