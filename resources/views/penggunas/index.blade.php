                    ...
                    <tr class="text-center">
                        ...
                        <td class="align-middle">
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                <a href="{{ route('penggunas.edit', $pg->id) }}" class="btn btn-warning d-flex align-items-center justify-content-center mr-2">
                                ...
                                <form action="{{ route('penggunas.destroy', $pg->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
                                    @csrf
                                    @method('DELETE')
