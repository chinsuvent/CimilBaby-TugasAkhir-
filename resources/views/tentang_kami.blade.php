        ...
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-6">
            <div class="hero-image">
              <img src="{{ 'pelanggan_assets/img/illustration/Rumah_Cimil_Baby.jpg' }}" alt="Business Growth" class="img-fluid" loading="lazy">
            </div>
          </div>
          <div class="col-lg-6 mb-4 mb-lg-0">
            ...
            <p class="description mb-4 text-white text-center">Ci'mil Baby adalah salah satu tempat penitipan anak di Kota Pontianak yang berdiri sejak tahun
                ...
                Dengan jam operasional setiap hari Senin hingga Jumat pukul 07.00 hingga 17.00.
            </p>
          </div>
