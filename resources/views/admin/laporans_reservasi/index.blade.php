...
@section('contents')
  ...
  <!-- Filter Atas -->
  <form method="GET" action="{{ route('laporans_reservasi.index') }}" class="mb-3">
  <div class="row g-2">
    ...
    <div class="col-md-3 d-flex align-items-end">
      <a href="{{ route('laporans_reservasi.cetak', request()->all()) }}" target="_blank" class="btn btn-purple w-100">Cetak PDF</a>
    </div>
  </div>
</form>
